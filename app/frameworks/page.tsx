          ...
          {activeTab === 'porters' ? (
            ...
            >
              ...
              <div className="md:col-span-3 bg-card/40 backdrop-blur-xl border border-card-border rounded-[24px] p-6 flex flex-col items-center text-center">
                ...
                <span className="px-3 py-1 bg-[#EF4444]/10 text-[#EF4444] text-xs font-bold rounded-full uppercase tracking-wider mb-4">
                  High Threat
                </span>
                <p className="text-sm text-text-secondary max-w-2xl">
                  The HSE market is dominated by legacy giants (Sphera, Intelex, Cority) fighting
                  for enterprise renewals. However, their rivalry is based on pricing and bundling,
                  not technological innovation. Empirisys enters by changing the battleground to
                  predictive AI.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="bg-card/40 backdrop-blur-xl border border-card-border rounded-[24px] p-6">
                  ...
                  <p className="text-sm text-text-secondary">
                    High barriers to entry due to the necessity of complex regulatory compliance
                    (ISO, OSHA). Startups struggle to gain enterprise trust. Empirisys overcomes
                    this via superior data ingestion speed.
                  </p>
                </div>
                <div className="bg-card/40 backdrop-blur-xl border border-card-border rounded-[24px] p-6">
                  <h3 className="text-sm font-bold text-text-primary mb-1">
                  ...
                  <p className="text-sm text-text-secondary">
                    Cloud infrastructure and LLM APIs (OpenAI, Anthropic) are becoming commoditized.
                    We are not locked into a single supplier for our AI pipeline.
                  </p>
                </div>
              </div>
              ...
              <div className="hidden md:flex items-center justify-center relative">
                ...
                <div className="w-32 h-32 bg-accent/10 rounded-full flex items-center justify-center border border-accent/30 z-10 backdrop-blur-md">
                  <span className="font-bold text-accent text-center leading-tight">
                    HSE
                    <br />
                    Market
                    <br />
              ...
              <div className="space-y-6">
                <div className="bg-card/40 backdrop-blur-xl border border-card-border rounded-[24px] p-6">
                  ...
                  <p className="text-sm text-text-secondary">
                    Enterprise buyers (Chevron, BP) dictate strict procurement terms. They demand
                    proven ROI. Empirisys must lead with hard data on incident reduction and lower
                    TCO vs. Sphera.
                  </p>
                </div>
                <div className="bg-card/40 backdrop-blur-xl border border-card-border rounded-[24px] p-6">
                  ...
                  <p className="text-sm text-text-secondary">
                    Excel and manual paper forms are the only true substitutes. Regulatory fines are
                    too severe for enterprises to not adopt dedicated software.
                  </p>
                </div>
              </div>
            </motion.div>
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="border-b border-card-border bg-panel/30">
                      <th className="p-4 text-xs font-bold text-text-secondary uppercase tracking-wider w-1/3">
                        Resource / Capability
                      </th>
                      <th className="p-4 text-xs font-bold text-text-secondary uppercase tracking-wider text-center">
                        Valuable?
                      </th>
                      <th className="p-4 text-xs font-bold text-text-secondary uppercase tracking-wider text-center">
                        Rare?
                      ...
                      <th className="p-4 text-xs font-bold text-accent uppercase tracking-wider">
                  ...
                  <tbody>
                    ...
                    <tr className="border-b border-card-border hover:bg-panel/50 transition-colors bg-accent/5">
                      <td className="p-4 font-bold text-accent">
                        Proprietary HSE Safety Vector DB
                      </td>
                      <td className="p-4 text-center text-accent">Yes</td>
                      <td className="p-4 text-center text-accent">Yes</td>
                      <td className="p-4 text-center text-accent">Yes</td>
                    ...
                    <tr className="border-b border-card-border hover:bg-panel/50 transition-colors">
                      ...
                      <td className="p-4 text-center text-text-secondary">No</td>
                      <td className="p-4 text-center text-accent">Yes</td>
                      <td className="p-4 text-sm font-bold text-text-secondary">
                        Competitive Parity
                      </td>
                    </tr>
                  </tbody>
              ...
              <div className="bg-panel border border-card-border rounded-[24px] p-6 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-text-secondary leading-relaxed">
                    Competitors like Intelex have Competitive Parity in basic mobile data capture.
                    Our Sustained Competitive Advantage lies solely in our proprietary HSE Safety
                    Vector DB and predictive modeling. We must focus all enterprise sales pitches
                    entirely on predictive insights, refusing to compete on basic reporting
                    features.
                  </p>
                </div>
              </div>
