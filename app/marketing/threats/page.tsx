  ...
  return (
    <div className="pb-16 bg-background min-h-screen z-10 relative">
      ...
      <div className="space-y-6 animate-in fade-in duration-500 w-full px-6 md:px-10 max-w-[1600px] mx-auto relative z-20">
        ...
        <div className="grid gap-6 md:grid-cols-4">
          ...
          <Card className="md:col-span-3">
            <CardHeader>
              ...
              <CardDescription>
                Live prioritized list of strategic risks identified by the AI.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {isLoading ? (
                  Array.from({ length: 3 }).map((_, i) => (
                    <div
                      key={i}
                      className="flex items-start justify-between rounded-lg border border-card-border p-4 animate-pulse"
                    >
                  ...
                  threats.map((threat) => (
                    <div
                      key={threat.id}
                      className="flex items-start justify-between rounded-lg border border-card-border p-4"
                    >
                      <div className="flex gap-4">
                        <div className="mt-1">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            {threat.level === 'critical' ? (
                              ...
                              <Badge
                                variant="outline"
                                className="text-amber-600 border-amber-200 bg-amber-50 dark:bg-amber-950/30 dark:text-amber-400 dark:border-amber-900"
                              >
                                High
                              </Badge>
                            )}
        ...
        <Dialog
          open={!!selectedThreat}
          onOpenChange={(open: boolean) => !open && setSelectedThreat(null)}
        >
          <DialogContent className="sm:max-w-[600px] bg-card/40 backdrop-blur-md border-card-border">
            ...
            <div className="mt-4 space-y-4">
              <div className="bg-panel p-4 rounded-lg border border-card-border">
                ...
                <p className="text-sm text-text-secondary dark:text-text-secondary">
                  The neural engine suggests immediate cross-functional review of this signal.
                  Recommended actions include auditing compliance with the new parameters mentioned,
                  preparing a responsive PR strategy, and monitoring primary competitors for
                  reactionary moves.
                </p>
              </div>
            </div>
            ...
            <DialogFooter className="mt-6">
              ...
              <Button className="bg-[var(--color-primary)] hover:brightness-110 text-text-alert text-text-primary">
