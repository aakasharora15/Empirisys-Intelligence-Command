...
export default function SettingsPage() {
  ...
  const [focusKeywords, setFocusKeywords] = useState('process safety, HSE analytics, safety culture software, COMAH compliance');
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-4">
                {[
                  ...
                  <button
                    key={t.id}
                    onClick={() => setColorTheme(t.id as 'default' | 'ocean' | 'forest' | 'sunset' | 'monochrome')}
                    className={cn(
...
{/* Competitor Discovery AI Engine */}
        <div className="glass-card p-6 shadow-sm space-y-6">
          ...
          <p className="text-xs text-text-secondary leading-relaxed max-w-2xl">
            Configure how the system automatically scans the web for emerging threats, new entrants, and stealth mode startups in the process safety and HSE software space.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-2">
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="text-xs font-bold text-text-primary mb-1">Enable AI Auto-Discovery</h4>
                  <p className="text-micro text-text-secondary">Run background scans on Google News, G2, and Crunchbase</p>
                </div>
                <button 
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="text-xs font-bold text-text-primary mb-1">Auto-promote High Confidence Threats</h4>
                  <p className="text-micro text-text-secondary">If AI confidence is &gt; 90%, add directly to tracking matrix</p>
                </div>
                <button 
