      ...
      <div className="w-full px-6 md:px-10 space-y-8 max-w-[1600px] mx-auto relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="bg-card/40 backdrop-blur-xl border border-card-border rounded-[24px] p-6"
          >
            ...
            <div className="space-y-4">
              <div className="bg-[#EF4444]/10 border border-[#EF4444]/20 p-4 rounded-xl">
                ...
                <p className="text-xs text-text-secondary">
                  Relies heavily on legacy SQL structures, making unstructured data ingestion (like
                  hazard reports or natural language) incredibly slow and rigid.
                </p>
              </div>
              <div className="bg-[#F59E0B]/10 border border-[#F59E0B]/20 p-4 rounded-xl">
                ...
                <p className="text-xs text-text-secondary">
                  Unable to natively perform semantic search across safety manuals. They rely on
          ...
          >
            ...
            <div className="space-y-4">
              <div className="bg-[#EF4444]/10 border border-[#EF4444]/20 p-4 rounded-xl">
                <h4 className="text-sm font-bold text-[#EF4444] mb-1">
                  On-Premises Technical Debt
                </h4>
                <p className="text-xs text-text-secondary">
                  Many core modules still rely on their older on-prem architecture, requiring VPNs
                  and complex networking for field workers to sync data.
                </p>
              </div>
              <div className="bg-accent/10 border border-accent/20 p-4 rounded-xl">
                ...
                <p className="text-xs text-text-secondary">
                  Our cloud-native, edge-computing model allows immediate data sync and AI
                  processing right on the mobile device, completely bypassing Intelex's network
                  bottleneck.
                </p>
              </div>
            </div>
