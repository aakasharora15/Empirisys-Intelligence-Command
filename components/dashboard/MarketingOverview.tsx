    ...
    <div className="w-full px-6 md:px-10 mb-16 max-w-[1600px] mx-auto">
      <div className="mb-10 border-b border-card-border/50 pb-6 flex items-end justify-between">
        <div>
          ...
          <p className="text-base text-text-secondary max-w-3xl">
            Live pipeline of active CAI profiles, automated analytics, and global neural signals
            routing directly into the marketing engine.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <motion.div
          ...
          className="bg-card border border-white/5 rounded-3xl p-6 md:p-8 flex flex-col justify-between group hover:border-[var(--color-primary)]/30 transition-all"
        >
          <div>
            ...
            <p className="text-sm text-text-secondary leading-loose mb-6">
              AI-driven profiles automatically scoring leads based on HSE compliance and strategic
              entry points.
            </p>
          ...
          <Link
            ...
            className="flex items-center gap-2 text-sm font-bold text-[var(--color-primary)] group-hover:translate-x-1 transition-transform"
          >
        ...
        <motion.div
          variants={itemVariants}
          className="bg-card border border-white/5 rounded-3xl p-6 md:p-8 flex flex-col justify-between group hover:border-blue-500/30 transition-all"
        >
          <div>
            ...
            <p className="text-sm text-text-secondary leading-loose mb-6">
              Strategic intelligence pipelines extracting structural events and converting them into
              actionable marketing themes.
            </p>
            ...
            <div className="space-y-3 mb-8">
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs text-text-secondary font-mono">
                  142 Events Extracted (24h)
                </span>
              </div>
              <div className="flex items-center gap-3">
                <div className="h-2 w-2 rounded-full bg-blue-400" />
                <span className="text-xs text-text-secondary font-mono">
                  4 Strategic Themes Active
                </span>
              </div>
            </div>
          </div>
          <Link
            href="/marketing/market-analyst"
            className="flex items-center gap-2 text-sm font-bold text-blue-400 group-hover:translate-x-1 transition-transform"
          >
        ...
        <motion.div
          variants={itemVariants}
          className="bg-card border border-white/5 rounded-3xl p-6 md:p-8 flex flex-col justify-between group hover:border-red-500/30 transition-all"
        >
          <div>
            ...
            <p className="text-sm text-text-secondary leading-loose mb-6">
              Live automated tracking of high-priority regulatory risks, Tier 1 incidents, and
              market signals.
            </p>
          ...
          <Link
            href="/marketing/threats"
            className="flex items-center gap-2 text-sm font-bold text-red-400 group-hover:translate-x-1 transition-transform"
          >
