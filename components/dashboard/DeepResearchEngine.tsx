  ...
  const churnSignals = [
    {
      ...
      quote:
        '"System is too clunky. Getting our safety data out requires a PhD. Needs predictive analytics."',
    ...
    <div className="w-full px-6 md:px-10 mb-20 max-w-[1600px] mx-auto mt-12">
      ...
      <div className="mb-10">
        ...
        <p className="text-base text-text-secondary max-w-4xl leading-relaxed">
          The Hub autonomously scrapes metadata and unstructured sentiment that humans cannot gather
          at scale. It maps hidden technology vulnerabilities and identifies competitor clients who
          are highly dissatisfied and ready to churn.
        </p>
      </div>
              ...
              >
                <div className="flex justify-between items-start">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs text-text-secondary font-mono bg-black/50 px-2 py-1 rounded">
                      Footprint detected
                    </span>
                  </div>
                  <span
          ...
          <div className="space-y-6">
            {churnSignals.map((signal, idx) => (
              ...
              >
                <div className="flex justify-between items-start border-b border-card-border/50 pb-3">
                  <div>
                    ...
                    <p className="text-xs text-text-secondary font-mono mt-1">
                      Targeting: {signal.currentVendor} • {signal.source}
                    </p>
                  </div>
                ...
                <p className="text-sm text-text-secondary italic">{signal.quote}</p>
