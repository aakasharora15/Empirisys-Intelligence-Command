  ...
  return (
    <div className="w-full px-6 md:px-10 mb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          <h3 className="text-sm font-semibold text-text-primary uppercase mb-2">Threat of New Entrants</h3>
        ...
        >
          <h3 className="text-sm font-semibold text-text-primary uppercase mb-2">Threat of Substitutes</h3>
          <div className="flex items-center gap-3 mb-4">
        ...
        >
          <h3 className="text-sm font-semibold text-text-primary uppercase mb-2">Competitive Rivalry</h3>
          <div className="flex items-center gap-3 mb-4">
