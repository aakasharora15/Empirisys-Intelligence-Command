...
export default function VrioAnalysis() {
  const vrioMetrics = [
    ...
    },
    {
      ...
      v: true, r: false, i: false, o: false,
    ...
    <div className="w-full px-6 md:px-10 mb-20 mt-16 max-w-[1600px] mx-auto">
      <div className="mb-8">
        ...
        <p className="text-base text-text-secondary mt-2">
          Every capability graded on Value • Rarity • Imitability • Organization — sustainable advantage requires all four.
        </p>
      </div>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-card-border bg-black/20">
              <th className="py-6 px-8 text-xs font-bold text-text-secondary uppercase tracking-widest">Capability</th>
              <th className="py-6 px-4 text-xs font-bold text-text-secondary uppercase tracking-widest text-center">V</th>
              <th className="py-6 px-4 text-xs font-bold text-text-secondary uppercase tracking-widest text-center">R</th>
              <th className="py-6 px-4 text-xs font-bold text-text-secondary uppercase tracking-widest text-center">I</th>
              <th className="py-6 px-4 text-xs font-bold text-text-secondary uppercase tracking-widest text-center">O</th>
              <th className="py-6 px-8 text-xs font-bold text-text-secondary uppercase tracking-widest text-right">Verdict</th>
            </tr>
          </thead>
          <tbody>
            {vrioMetrics.map((item, idx) => (
              ...
              >
                ...
                <td className="py-6 px-8 text-right">
                  <span className={`px-4 py-2 rounded-full text-xs font-black uppercase tracking-widest border ${item.color} ${item.bg}`}>
                    {item.advantage}
                  </span>
                </td>
              </motion.tr>
