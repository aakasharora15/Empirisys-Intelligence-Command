...
export function CommandPalette({
  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-[100] flex items-start justify-center pt-[15vh]">
      ...
      >
        <Command className="w-full flex flex-col" loop shouldFilter={true}>
          ...
          <Command.List className="max-h-[400px] overflow-y-auto p-2 scrollbar-thin">
            ...
            <Command.Group
              ...
              className="px-2 py-1 text-xs font-bold text-[var(--color-text-muted)] uppercase tracking-wider"
            >
              <Command.Item
            ...
            <Command.Group
              ...
              className="px-2 py-1 text-xs font-bold text-[var(--color-text-muted)] uppercase tracking-wider mt-2"
            >
              <Command.Item
