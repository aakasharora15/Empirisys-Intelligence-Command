...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'default', size = 'default', ...props }, ref) => {
    const variants = {
      ...
      secondary:
        'bg-[var(--color-base)] text-[var(--color-text-primary)] hover:bg-slate-200 shadow-sm',
      outline:
        'border border-[var(--color-border)] bg-white text-[var(--color-text-primary)] hover:bg-[var(--color-base)] shadow-sm',
