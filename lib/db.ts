...
export interface EmpirisysKnowledge {
  ...
  content: string;
  type: string;
  section: 'About' | 'BOOST' | 'SENSE' | 'Empirisys 360' | 'Clients' | 'Differentiators' | 'Target Industries';
}
...
export const mockCompetitors: Competitor[] = [
  {
    ...
    founded: '2016',
    hq: 'Aberdeen UK',
    description: 'Closest direct competitor making similar claims regarding safety intelligence, but reported execution quality issues exist.',
    type: 'Direct',
    ...
    strengths: ['Uses very similar messaging to Empirisys', 'Strong presence in Aberdeen offshore sector'],
    weaknesses: ['Clients report poor implementation quality (Empirisys asked to redo their work)', 'May lack deep proprietary LLM capabilities'],
  ...
  },
  {
    ...
    founded: '1864',
    hq: 'Hovik Norway',
    description: 'Incumbent System of Record. Massive data capture tool but fails to connect datasets into actionable decision support.',
    type: 'Indirect',
    ...
    strengths: ['Massive global footprint and brand authority', 'Used as the default system of record by many operators', 'Prospects often cite the "perceived risk of moving away from established brands" as their primary hurdle.'],
    weaknesses: ['Legacy architecture is highly complex', 'Analysis is purely retrospective bar charts, no decision support'],
  ...
  },
  {
    ...
    weaknesses: ['Like DNV, focuses on capture rather than real-time NLP insight', 'Complex deployment'],
  ...
  },
  {
    ...
    founded: '2010',
    hq: 'UK',
    description: 'Observation-only incumbent linked to Step Change in Safety. Empirisys rebuilt it, making it both a route into accounts and a messaging challenge.',
    type: 'Partner',
    ...
    weaknesses: ['Observation-only (lacks incidents/actions linking)', 'Muddy messaging when BOOST is sold inside eOBS'],
  ...
  },
  {
    ...
    founded: '2023',
    hq: 'Global',
    description: 'Customers attempting to stitch together PowerBI, Excel, and generic AI (Copilot) to analyze safety logs internally.',
    type: 'Substitute',
    ...
    strengths: ['Perceived as "free" since they already pay for Microsoft 365', 'Data stays internal', 'Prospects hold a massive misconception that Empirisys is equivalent to using Copilot on their own data.'],
    weaknesses: ['Produces one-off conversational outputs rather than repeatable analytical workflows', 'Lacks safety governance, trackability, and the underlying data architecture required for high-hazard environments'],
  ...
  },
  {
    ...
    weaknesses: ['Less focused on front-line NLP data extraction compared to Empirisys', 'Expensive'],
  ...
  },
  {
    ...
    weaknesses: ['AI features are surface level add-ons', 'Less suited for highly complex offshore environments'],
  ...
  },
  {
    ...
    weaknesses: ['Not focused heavily on predictive modeling or NLP', 'Fragmented platform due to acquisitions'],
...
export const mockDiscoveryLogs: DiscoveryLog[] = [
  {
    ...
    why_flagged: 'Press release: "SafetyLens AI raises Series A to bring LLMs to safety culture logs"',
...
export const mockCompetitorContent: CompetitorContent[] = [
  {
    ...
    summary: 'CEO announced a shift from historical logs to predictive ESG modeling leveraging Blackstone backed resource layers.',
  ...
  },
  {
    ...
    summary: 'A comprehensive study highlighting DNV Synergi Life data sets and their limitations in predicting unstructured near miss logs.',
  ...
  },
  {
    ...
    summary: 'A product manager writes about moving away from slow audits to continuous real time event logging in industrial sites.',
    sentiment_score: 'positive',
    relevance_score: 85,
    engagement_count: 89,
  ...
  },
  {
    ...
    summary: 'Cority wins local government contract to track water infrastructure maintenance observations using myCority mobile app.',
    sentiment_score: 'positive',
    relevance_score: 79,
    engagement_count: 45,
  ...
  },
  {
    ...
    summary: 'Detailed statistics showing that contractor onboarding safety checks fail 14 percent of the time on first inspection.',
    sentiment_score: 'neutral',
    relevance_score: 91,
...
export const mockKnowledge: EmpirisysKnowledge[] = [
  ...
  },
  {
    ...
    content: 'SENSE is our cultural diagnostic tool. It measures safety culture alignment leadership capabilities and worker engagement. By matching qualitative survey data with quantitative operational records it highlights where leadership behavior needs intervention to reduce compliance risk.',
  ...
  },
  {
    ...
    content: 'Empirisys 360 combines SENSE diagnostics and BOOST analytics with specialized consulting services. This framework provides an end to end pathway to transform industrial safety culture by combining operational technology insights with human factors and training.',
  ...
  },
  {
    ...
    content: 'We actively partner with leading industrial and utility organizations. Key clients include BP (offshore platform log processing) Thames Water (culture and compliance auditing) SSE (renewable energy safety metrics) Ithaca Energy and Harbour Energy (North Sea oil rig risk models) Drax and Wessex Water.',
  ...
  },
  {
    ...
    content: 'We focus on high hazard asset intensive sectors. This includes Oil and Gas (offshore and onshore) Utilities (water and electricity distribution) Nuclear power generation Chemicals manufacturing and Maritime transport. Our safety models are tuned to COMAH regulated sites.',
    type: 'Market Focus',
...
export const mockTriggerEvents: TriggerEvent[] = [
  {
    ...
    why_relevant: 'Immediate demand driver for BOOST NLP ingestion at all COMAH regulated sites before October deadline.'
  },
  {
    id: 'te2',
    ...
    severity: 'High',
    category: 'HSE Notice',
    why_relevant: 'Opens a direct pathway for SENSE culture diagnostic deployment across Thames Water treatment assets.'
  },
  {
    id: 'te3',
    ...
    severity: 'High',
    category: 'Incident',
    why_relevant: 'Demonstrates the SENSE subcontractor behavioral vetting gap across UK construction sector.'
  },
  {
    id: 'te4',
    ...
    why_relevant: 'Directly reinforces the BOOST NLP alarm triage narrative for oil and gas prospects in Aberdeen.'
  },
  {
    id: 'te5',
    title: 'ONR mandates quarterly contractor cultural assessments at nuclear decommissioning sites',
    source: 'ONR UK',
    published_at: '18 June 2026',
    severity: 'High',
    category: 'Regulatory Change',
    why_relevant: 'Expands SENSE assessment addressable market into the nuclear decommissioning sector immediately.'
  },
  {
    id: 'te6',
    ...
    severity: 'Medium',
    category: 'Incident',
    why_relevant: 'Validates BOOST log parsing for offshore renewables and increases SSE prospect urgency.'
  }
];
...
export const mockQueries: QueryLog[] = [
  {
    ...
    results_json: { response: 'BOOST parses unstructured text logs whereas Intelex and Sphera rely on structured compliance forms.' },
  ...
  },
  {
    ...
    results_json: { response: 'Thames Water published a safety culture project valued at 2 million pounds.' },
...
export async function addQuery(question: string, module_type: string, results_json: Record<string, unknown>): Promise<void> {
...
export const mockClientAnalyses: ClientAnalysis[] = [
  {
    ...
    hse_track_record: 'Strong safety focus but challenged by legacy North Sea infrastructure issues',
    hse_risk_score: 78,
    incumbent_consultant: {
      name: 'DNV',
      estimated_value: 4500000,
      duration: '3 years',
      weakness: 'Legacy configuration forms create administrative delay and ignore unstructured logs'
    },
    incidents_json: [
      {
        date: 'June 2025',
      ...
      {
        date: 'March 2026',
        description: 'Refinery telemetry near miss alarm fatigue resulting in delayed shut off valve response',
        severity: 'High'
      }
    ],
    pitch_strategy: {
      overview: 'BP requires real time data ingestion for offshore near miss logs to replace slow manual auditing checklists.',
  ...
  },
  {
    ...
    pitch_strategy: {
      overview: 'Shell needs mobile offline near miss log reporting and BOOST NLP integration to resolve rigging risk vectors.',
  ...
  },
  {
    ...
    pitch_strategy: {
      overview: 'Balfour Beatty requires SENSE culture diagnostics to monitor subcontractor compliance behaviors in real time.',
  ...
  },
  {
    ...
    hse_track_record: 'Under intense regulatory oversight on pollution and facility safety compliance',
    hse_risk_score: 85,
    incumbent_consultant: {
      name: 'Intelex',
    ...
    pitch_strategy: {
      overview: 'Thames Water requires BOOST NLP to parse low level maintenance observations and prevent overflows.',
      products: ['BOOST', 'SENSE'],
      key_points: [
  ...
  },
  {
    ...
    pitch_strategy: {
      overview: 'SSE needs a centralized predictive safety telemetry dashboard utilizing SENSE diagnostics.',
      products: ['SENSE'],
      key_points: [
  ...
  },
  {
    ...
    pitch_strategy: {
      overview: 'Harbour Energy requires BOOST NLP to parse drilling logs and identify latent safety risks before isolation checks.',
  ...
  },
  {
    ...
    pitch_strategy: {
      overview: 'Drax needs real time risk telemetry dashboards utilizing BOOST NLP on plant operator logs.',
      products: ['BOOST'],
      key_points: [
...
export const mockNearMissFeed: NearMissEvent[] = [
  {
    ...
    description: 'Wind turbine technician near miss transfer event during rough sea conditions offshore North Sea',
  ...
  },
  {
    ...
    description: 'Refinery telemetry alarm fatigue event leading to pressure build up inside separator unit',
  ...
  },
  {
    ...
    description: 'Chemical overflow warning alert at water purification plant near Reading during discharge',
  ...
  },
  {
    ...
    company_name: 'Shell',
    category: 'Subcontractor Fatality Risk Event',
    description: 'Subcontractor fall protection lanyard failure near miss event on offshore platform deck',
  ...
  },
  {
    ...
    description: 'Soil wall stability warning alert during highway excavation works near Leeds bypass sector',
    source: 'RIDDOR incident reports',
  ...
  },
  {
    ...
    description: 'Isolation valve seal degradation observation recorded during pipeline check on rig C',
    source: 'Google News RSS',
  ...
  },
  {
    ...
    description: 'Biomass fuel conveyor belt thermal sensor alert near miss during intake shutdown phase',
    source: 'Company press release',
...
export async function getNearMissFeed(): Promise<NearMissEvent[]> {
  if (supabase) {
    const { data, error } = await supabase.from('near_miss_feed').select('*').order('created_at', { ascending: false });
    if (!error && data && data.length > 0) {
...
export async function addClientAnalysis(analysis: Omit<ClientAnalysis, 'id'>): Promise<ClientAnalysis> {
...
export async function addManualWatchlist(nameOrUrl: string): Promise<Competitor> {
  ...
  const comp: Competitor = {
    ...
    logoUrl: 'https://ui-avatars.com/api/?name=SafetyLens&background=020617&color=eab308&size=256&font-size=0.33&bold=true'
  };
  ...
  mockDiscoveryLogs.unshift({
    ...
    source: 'Manual Entry',
    detected_at: new Date().toLocaleDateString('en-GB', { day: 'numeric', month: 'short', year: 'numeric' }),
    confidence_score: 100,
    status: 'WATCHLIST'
  });
